...
R encode_res_sleep(EI * const _c_iter, struct res_sleep const * const _c_obj) {
  ...
  case res_sleep_tag_needs_reset: /* No data for field needs_reset with index 2. */ break;
...
R decode_res_sleep(DI * const _c_iter, struct res_sleep * const _c_obj) {
  ...
  case res_sleep_tag_needs_reset: /* No data for field i"needs_reset" with index 2. */ break;
