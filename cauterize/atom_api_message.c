...
const caut_type_descriptors_atom_api_t type_descriptors = {
  {
    .name = "res_send",
    .hash = { 0x87,0xF2,0x37,0x94,0x1C,0xB9,0x7A,0x35,0x0D,0xBC,0x65,0x9F,0x38,0xB5,0x3C,0x82,0xC0,0xC7,0xCF,0xAA },
  ...
  {
    .name = "cmd_send",
    .hash = { 0x1C,0x2F,0x4B,0xBE,0x9E,0x39,0x66,0xE3,0xA7,0xB3,0xA2,0xB4,0x11,0xD0,0x14,0x0A,0xB4,0xB3,0x0E,0x55 },
  ...
  {
    .name = "cmd",
    .hash = { 0xB7,0xD4,0x73,0x0B,0xA6,0x41,0x8E,0x7E,0xF6,0x05,0x92,0x0F,0x96,0x9F,0x5F,0xD5,0xD2,0x57,0x49,0x14 },
  ...
  {
    .name = "txn",
    .hash = { 0xDE,0x4C,0x1D,0x47,0x9B,0x35,0x0D,0x1F,0x49,0x1B,0x6B,0x2C,0xE1,0x28,0x0A,0x00,0x8B,0x2B,0x91,0x8B },
