...
const caut_type_descriptors_atom_api_t type_descriptors = {
  ...
  {
    .name = "res_poll",
    .hash = { 0xFE,0x3B,0xEA,0xF4,0x4B,0x49,0xC8,0xE5,0x05,0x87,0xDC,0xF4,0x02,0xEA,0xF1,0xCE,0xEF,0x65,0x51,0xCD },
  ...
  {
    .name = "cmd_poll",
    .hash = { 0x56,0x39,0x27,0xF3,0x57,0x00,0x8D,0x8F,0x9B,0x0C,0x79,0x71,0xAD,0x4E,0x0B,0x75,0x0E,0x31,0xB4,0xAA },
  ...
  },
  {
    ...
    .hash = { 0x75,0x20,0x48,0xED,0x5C,0xE1,0x74,0x61,0x34,0x69,0x4B,0x27,0xE0,0xF9,0xA3,0xCB,0x26,0xBA,0x90,0x85 },
  ...
  {
    .name = "res_sleep",
    .hash = { 0x2F,0xAE,0x84,0xC4,0x62,0xD2,0x63,0x94,0xEF,0x13,0xB6,0x8B,0x9E,0x4D,0xE6,0x53,0x49,0x25,0x51,0xA1 },
  ...
  {
    .name = "cmd_sleep",
    .hash = { 0xE4,0x83,0x54,0x13,0x65,0x6A,0xA2,0x27,0xA3,0x4B,0x42,0xDD,0x31,0xFA,0xF7,0xFC,0x72,0x3D,0x45,0x17 },
  ...
  {
    .name = "cmd",
    .hash = { 0xE8,0xBD,0x4F,0xF6,0xC5,0x60,0x89,0x28,0xD7,0x9B,0x82,0xBB,0xC3,0x83,0xB4,0xA5,0x7A,0xD3,0x8F,0x59 },
  ...
  {
    .name = "txn",
    .hash = { 0xCE,0x41,0x63,0x33,0x6F,0x1A,0x1F,0x55,0xCB,0x5B,0x61,0x07,0xB8,0xA9,0x3E,0x44,0x8D,0x0F,0xD6,0x05 },
