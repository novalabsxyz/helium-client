...
const caut_type_descriptors_atom_api_t type_descriptors = {
  ...
  {
    .name = "cmd_sleep",
    .hash = { 0x15,0x42,0x1F,0xD7,0xCB,0x0C,0x66,0x48,0xEF,0x04,0xD1,0xBF,0x47,0xF3,0xAA,0x1F,0xEE,0xB8,0x2C,0xAE },
  ...
  {
    .name = "cmd",
    .hash = { 0xE3,0xD7,0x88,0xD5,0x2E,0x07,0x8D,0x44,0x48,0xB6,0x6A,0xDF,0x16,0xB1,0x46,0x82,0x70,0x01,0x75,0xA6 },
  ...
  {
    .name = "txn",
    .hash = { 0xD8,0x3D,0x4C,0x94,0x10,0xC5,0x5A,0x18,0x17,0xCB,0x0F,0x8E,0x2E,0xDD,0x27,0xE7,0xB2,0xA4,0x99,0xA4 },
