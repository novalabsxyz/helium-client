...
const caut_type_descriptors_atom_api_t type_descriptors = {
  ...
  {
    .name = "cmd_poll",
    .hash = { 0x18,0xB9,0xC8,0x86,0xC5,0xB7,0x5A,0x1F,0x58,0xD6,0x47,0xB9,0x55,0x64,0x83,0x9F,0x8C,0x33,0x0A,0x58 },
  ...
  {
    .name = "cmd",
    .hash = { 0x62,0xD8,0xCD,0x59,0x9F,0x15,0x0E,0xD8,0x8C,0xC1,0x26,0xD6,0xEA,0xC1,0xA2,0x82,0x5E,0x48,0x3B,0x03 },
  ...
  {
    .name = "txn",
    .hash = { 0x76,0x11,0x84,0xB0,0xB1,0x60,0x7D,0xA6,0x7A,0x14,0x46,0x8E,0x07,0x06,0xFE,0x62,0xB9,0x38,0x9E,0x41 },
